define({ "api": [
  {
    ...
    "filename": "src/main/java/com/ydl/api/bigDataPlatform/demograghicData/DemographicdataApi.java",
    "groupTitle": "人口数据",
    "sampleRequest": [
      {
  ...
  {
    "name": "Demographicdata_getAllPaging",
    "type": "POST",
  ...
  },
  {
    ...
    "filename": "src/main/java/com/ydl/api/LayersListApi.java",
    "groupTitle": "图层列表",
    "sampleRequest": [
      {
  ...
  },
  {
    ...
    "filename": "src/main/java/com/ydl/api/LayerInfoApi.java",
    "groupTitle": "图层详细信息",
    "sampleRequest": [
      {
        "url": "http://localhost:8888/LayerInfo/getLayerInfo"
      }
    ]
  },
  {
    "name": "ThreeDimensional_getAllNamePaging",
    "type": "POST",
    "url": "ThreeDimensional/getAllNamePaging",
    "title": "获取所有3D模型名字",
    "group": "基本空间数据",
    "version": "0.0.2",
    "description": "<p>用于获取所有3D模型名字</p>",
    "success": {
      "fields": {
        "200": [
          {
    ...
    "filename": "src/main/java/com/ydl/api/bigDataPlatform/basicspatialdata/ThreeDimensionalApi.java",
    "groupTitle": "基本空间数据",
    "sampleRequest": [
      {
        "url": "http://localhost:8888/ThreeDimensional/getAllNamePaging"
      }
    ]
  },
  {
    "name": "ThreeDimensional_getThreeDimensional",
    "type": "POST",
    "url": "ThreeDimensional/getThreeDimensional",
    "title": "获取3D模型信息",
    "group": "基本空间数据",
    "version": "0.0.2",
    "description": "<p>用于获取3D模型信息</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
    ...
    "sampleRequest": [
      {
        "url": "http://localhost:8888/ThreeDimensional/getThreeDimensional"
      }
    ]
  },
  {
    ...
    "filename": "src/main/java/com/ydl/api/TestApi.java",
    "groupTitle": "模板样例",
    "sampleRequest": [
      {
        "url": "http://localhost:8888/template/template"
      }
    ]
  },
  {
    "name": "BasicRuralConditions_getDataByTableName",
    "type": "POST",
    "url": "BasicRuralConditions/getDataByTableName",
    "title": "农村基本情况",
    "group": "经济数据",
    "version": "0.0.2",
    "description": "<p>用于获取农村基本情况统计的数据</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
    ...
    "filename": "src/main/java/com/ydl/api/bigDataPlatform/economicData/BasicRuralConditionsApi.java",
    "groupTitle": "经济数据",
    "sampleRequest": [
      {
        "url": "http://localhost:8888/BasicRuralConditions/getDataByTableName"
      }
    ]
  },
  {
    "name": "BasicSocialSituation_getDataByTableName",
    "type": "POST",
    "url": "BasicSocialSituation/getDataByTableName",
    "title": "社会经济基本情况",
    "group": "经济数据",
    "version": "0.0.2",
    "description": "<p>用于获取社会经济基本情况统计的数据</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "tableName",
            "description": "<p>表代称（可选分为：BasicSocialSituation1_2014，BasicSocialSituation2_2014，BasicSocialSituation1_2015，BasicSocialSituation2_2015，BasicSocialSituation1_2016，BasicSocialSituation2_2016）</p>"
          }
        ]
      },
      "examples": [
    ...
    "filename": "src/main/java/com/ydl/api/bigDataPlatform/economicData/BasicSocialSituationApi.java",
    "groupTitle": "经济数据",
    "sampleRequest": [
      {
        "url": "http://localhost:8888/BasicSocialSituation/getDataByTableName"
      }
    ]
  },
  {
    "name": "EconomicData_classification",
    "type": "POST",
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "tableName",
            "description": "<p>分类名字(可选情况分为：农业主要经济指标，农村基本情况，生产总值统计，农民人均纯收入，社会经济基本情况)</p>"
          },
          {
            "group": "Parameter",
            "type": "JSON",
    ...
    "filename": "src/main/java/com/ydl/api/bigDataPlatform/economicData/EconomicDataApi.java",
    "groupTitle": "经济数据",
    "sampleRequest": [
      {
  ...
  {
    "name": "GDPStatistics_getDataByTableName",
    "type": "POST",
    "url": "GDPStatistics/getDataByTableName",
    "title": "生产总值统计",
    "group": "经济数据",
    "version": "0.0.2",
    "description": "<p>用于获取生产总值统计的数据</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
    ...
    "filename": "src/main/java/com/ydl/api/bigDataPlatform/economicData/GDPStatisticsApi.java",
    "groupTitle": "经济数据",
    "sampleRequest": [
      {
        "url": "http://localhost:8888/GDPStatistics/getDataByTableName"
      }
    ]
  },
  {
    "name": "MainEconomicIndicatorsOfAgriculture_getDataByTableName",
    "type": "POST",
    "url": "MainEconomicIndicatorsOfAgriculture/getDataByTableName",
    "title": "农业主要经济指标",
    "group": "经济数据",
    "version": "0.0.2",
    "description": "<p>用于获取农业主要经济指标统计的数据</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
    ...
    "filename": "src/main/java/com/ydl/api/bigDataPlatform/economicData/MainEconomicIndicatorsOfAgricultureApi.java",
    "groupTitle": "经济数据",
    "sampleRequest": [
      {
  ...
  {
    "name": "RuralPerCapitaNetIncome_getDataByTableName",
    "type": "POST",
    "url": "RuralPerCapitaNetIncome/getDataByTableName",
    "title": "农民人均纯收入",
    "group": "经济数据",
    "version": "0.0.2",
    "description": "<p>用于获取农民人均纯收入的数据</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
    ...
    "filename": "src/main/java/com/ydl/api/bigDataPlatform/economicData/RuralPerCapitaNetIncomeApi.java",
    "groupTitle": "经济数据",
    "sampleRequest": [
      {
