define({ "api": [
  ...
  },
  {
    ...
    "filename": "src/main/java/com/ydl/api/BasicRuralConditionsApi.java",
    "groupTitle": "经济数据",
    "sampleRequest": [
      {
  ...
  {
    "name": "GrossProduct_getDataByTableName",
    "type": "POST",
    "url": "GrossProduct/getDataByTableName",
    "title": "生产总值统计",
    "group": "经济数据",
    "version": "0.0.2",
    ...
    "filename": "src/main/java/com/ydl/api/GDPStatisticsApi.java",
    "groupTitle": "经济数据",
    "sampleRequest": [
      {
        "url": "http://localhost:8888/GrossProduct/getDataByTableName"
      }
    ]
  },
  {
