...
public class ThreeDimensionalApi {
    ...
    public Object getThreeDimensional(@RequestBody Map<String, Object> models, HttpServletResponse httpServletResponse) throws Exception {
        ThreeDimensional threeDimensional = JsonXMLUtils.map2obj((Map<String, Object>) models.get("threeDimensional"), ThreeDimensional.class);
...
//        threeDimensionalService.getThreeDimensional(threeDimensional);
    ...
    public Object getAllNamePaging(@RequestBody Map<String, Object> models, HttpServletResponse httpServletResponse) {
//        httpServletResponse.setHeader("Access-Control-Allow-Origin", "*");
//        System.out.println(threeDimensional.getKeyvalue());
//        threeDimensionalService.getThreeDimensional(threeDimensional);
